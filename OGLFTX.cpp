/*
 * OGLFTX: A library for drawing text with OpenGL using the FreeType library
 * Copyright (C) 2002 lignum Computing, Inc. <OGLFTX@lignumcomputing.com>
 * $Id: OGLFTX.cpp,v 1.11 2003/10/01 14:21:18 allen Exp $
 *
 ...
 *
 * OGLFTX is based upon OGLFTX, as noted above, and was developed in 2012 to
...
float OGLFTX::FONT_FUDGE_FACTOR(64.0f);
